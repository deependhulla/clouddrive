...
$sx[$s]="nextcloud.com";$sy[$s]="deependhulla.com";$s++;
$sx[$s]="com.nextcloud.client";$sy[$s]="com.deependhulla.clouddrive";$s++;
$sx[$s]="Nextcloud";$sy[$s]="CloudDrive";$s++;
#$sx[$s]="";$sy[$s]="";$s++;
#$sx[$s]="";$sy[$s]="";$s++;
...
$flist=array();
$flistx="";
$cmdx="find android -type f -name *.xml";
$flistx=$flistx."\n".`$cmdx`;

$cmdx="find android -type f -name *.java";
$flistx=$flistx."\n".`$cmdx`;

$cmdx="find android -type f -name *.gradle";
$flistx=$flistx."\n".`$cmdx`;

$cmdx="find android -type f -name *.json";
$flistx=$flistx."\n".`$cmdx`;
